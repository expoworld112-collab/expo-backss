...
//     if (!res.ok) {
//       console.error("Slug API failure:", res.status);
//       return [];
//     }
...
//     return json;
//   } catch (e) {
//     console.error("Slug API crashed:", e);
//     return [];
//   }
// };
// export const allslugs = async () => {
...
//   } catch (err) {
//     console.error("All Slugs Error:", err.message);
//     return []; // return empty array to avoid .filter() errors
//   }
// };
...
export async function getStaticPaths() {
  ...
  const paths = (slugs || []).map(slug => ({
    params: { slug: slug.slug || slug } // support string or object
  }));

  return {
    paths,
    fallback: "blocking", // build pages on-demand
  };
}
>>>>>>> e8a0b69400c985ecdc3d87f5e13e4a922745963b
